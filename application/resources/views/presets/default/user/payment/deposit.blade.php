                    ...
                    <form action="{{ route('user.deposit.insert') }}" method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="mt-3 preview-details d-none">
                                ...
                                <span><span class="min fw-bold">0</span> {{ $general->cur_text }} - <span
                                        class="max fw-bold">0</span> {{ $general->cur_text }} , </span>
                                <span>@lang('Charge')</span>
                                <span><span class="charge fw-bold">0</span> {{ $general->cur_text }}
                                    ,</span>
