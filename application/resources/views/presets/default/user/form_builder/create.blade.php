        ...
        <div class="row g-4 justify-content-center">
                        ...
                        <div class="row g-4">
                            <div class="col-xxl-6">
                                <div class="logo-upload--box">
                                    <x-image-uploader name="image" :imagePath="getImage(getFilePath('form') . '/', getFileSize('form'))" :size="getFileSize('form')" :isImage="true"
                                        class="w-50" id="uploadLogo3" :baseColor="true" :required="true" />
                                </div>
                            </div>
                            <div class="col-xxl-6">
                                <div class="row">
            ...
            <div class="col-lg-6">
                <div class="profile__wrap card p-4">
                    ...
                    <div class="mb-4">
                        <p>@lang('Your current credit is'): {{ showAmount(auth()->user()->credit) }}</p>
            ...
            <div class="col-12">
                <div class="app">
                    ...
                    <div class="canvas palette profile__wrap card p-4">
                        ...
                        <div id="dropZone" class="drop-zone" ondragover="event.preventDefault()" data-plc="@lang('Drag and drop here')"></div>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-12">
                                    <div class="meta__single">
                                        <label class="form--label">@lang('Type'): <span id="metaType"></span></label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="meta__single">
                                    ...
                                    <div class="meta__single">
                                        <div>
                                            ...
                                            <div class="meta__select">
                                                <input id="newOption" class="form--control" type="text" placeholder="@lang('option text')">
                                                <button id="addOption" class="btn btn--sm btn--base w-100 mt-2" disabled>@lang('Add')</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="meta__single">
                                        <div class="meta__btn">
                                            <button id="applyBtn" class="btn btn--sm btn--base w-100">@lang('Apply')</button>
                                            <button id="deleteBtn" class="trash btn btn--sm btn--danger w-100">@lang('Delete')</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    renderOptionsList(el);
        ...
        document.getElementById("exportJsonBtn").addEventListener("click", () => {
            ...
            const exportData = {
                ...
                submission_limit: document.getElementById("submission_limit").value || 10,
