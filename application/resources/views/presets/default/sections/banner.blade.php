            ...
            <div class="col-lg-6">
                <div class="banner__content">
                    ...
                    <div class="banner__btns mt-40">
                        <a href="{{ route('user.login') }}" class="btn btn--base">{{__($bannerSectionContent->data_values->button_one)}}</a>
                        <a href="{{ route('user.form.create') }}" class="btn btn--white">{{__($bannerSectionContent->data_values->button_two)}}</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
