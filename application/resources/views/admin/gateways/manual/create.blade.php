                        ...
                        <div class="row mb-4">
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="logo-upload--box">
                                    <x-image-uploader name="image" :imagePath="getImage(getFilePath('paymentGateway') . '/',getFileSize('paymentGateway'))" :size="getFileSize('paymentGateway')" :isImage="false" class="w-100" id="uploadLogo3" :required="false" />
                                </div>
                            </div>
