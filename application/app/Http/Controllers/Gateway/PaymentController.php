...
class PaymentController extends Controller
{
    ...
    public function manualDepositConfirm()
    {
        ...
        if ($data->method_code > 999) {
            $pageTitle = $data->is_credit_purchase ? 'Credit Payment' : 'Deposit Payment';
    ...
    public function manualDepositUpdate(Request $request)
    {
        ...
        $type = $data->is_credit_purchase ? 'Credit Payment' : 'Deposit Payment';
    ...
    public static function userDataUpdate($deposit, $isManual = null)
    {
        ...
        if ($deposit->status == Status::PAYMENT_PENDING || $deposit->status == Status::PAYMENT_INITIATE) {
           ...
           if ($deposit->is_credit_purchase) {
            ...
            $transaction->trx_type     = $deposit->is_credit_purchase ? '-' : '+';
            ...
            $notifyData = [
                ...
                'number_of_credit' => $deposit->number_of_credit,
            ];
